...
Current release target: `V0.76.0`.
...
- `SmartiAI-Agent-for-Windows-0.76.0-Setup.exe`
- `SmartiAI-Agent-for-Windows-0.76.0-win-x64-portable.zip`
...
For `V0.76.0`, publish a GitHub release tagged `V0.76.0` or `0.76.0` and attach:
...
עבור `V0.76.0`, יש לפרסם GitHub Release עם תגית `V0.76.0` או `0.76.0` ולצרף:
