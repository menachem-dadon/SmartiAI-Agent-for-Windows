...
REQUEST_SCHEMAS = {
    ...
    "memoryAction": _object({
        "action": {"type": "string", "enum": ["details", "reveal", "edit", "archive", "restore", "delete"]},
    ...
    "toolAction": _object({
        "action": {"type": "string", "enum": ["set_trust", "set_enabled", "refresh", "install_skill", "install_custom", "install_mcp"]},
    ...
    "diagnosticAction": _object({
        "action": {"type": "string", "enum": ["scan", "repair"]}, "include_network": {"type": "boolean"}, "repair_id": IDENTIFIER,
    }),
